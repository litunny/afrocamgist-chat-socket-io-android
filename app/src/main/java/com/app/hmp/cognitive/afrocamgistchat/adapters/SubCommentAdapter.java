...
public class SubCommentAdapter extends RecyclerView.Adapter<SubCommentAdapter.DataObjectHolder> implements MenuAdapter.OnMenuItemClickListener{
    ...
    public SubCommentAdapter(Activity context, int parentPosition, Comment parentComment, ArrayList<Comment> comments, OnCommentClickListener listener) {
    ...
    public DataObjectHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_sub_comment, viewGroup, false);
...
//                            .putExtra("userId", comments.get(holder.getAdapterPosition()).getCommentedBy().getUserId()));
        ...
        holder.reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                listener.onReplyClicked(parentPosition, parentComment, comments.get(holder.getAdapterPosition()));
            }
        });
    ...
    public void onMenuItemClicked(String item, int commentPosition) {
        ...
        switch (item.toLowerCase()) {
            ...
            case "edit":
                listener.onEditCommentClicked(parentPosition, parentComment, commentPosition, comments.get(commentPosition));
                break;
            case "delete":
                listener.onDeleteCommentClicked(parentPosition, parentComment, commentPosition, comments.get(commentPosition));
                break;
            default:
                break;
        }
    ...
    public interface OnCommentClickListener {
        ...
        void onReplyClicked(int parentPosition, Comment parentComment, Comment comment);
